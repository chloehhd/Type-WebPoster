...
// -----------------SEARCH NAV-------------------------- 
// Don't need this section if the nav bar is only shown when you hover 
...
// im encoutering and error that when I press the backspace before entering a lectuers name in the input box, it will go to that page but continue to disaply the search section after a half second delay
